...
app.post("/guestlist", async (req,res) => {
    ...
    await guestPassModel.create(req.body);
...
app.delete("/guestlist/:guestId", async (req,res) => {
    ...
    res.redirect(`/guestlist/${req.params.fruitId}`);
})
//-----------------UPDATE-------------------------
